                    ...
                    <table class="table table-nowrap datatable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00025</a> </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00024</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00023</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00022</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00021</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00020</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00019</a></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00018</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00017</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00016</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                            ...
                            <tr>
                                ...
                                <td> <a href="#" class="text-gray-5"> TXN2025022212 </a> </td>
                                <td> <a href="{{url('invoice-details')}}" class="link-default">INV00015</a> </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('customer-details')}}" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
