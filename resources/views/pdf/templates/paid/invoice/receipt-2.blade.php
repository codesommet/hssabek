                ...
                <div class="receipt-header">
                    <table class="table table-nowrap border-dashed mb-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border-0"></td>
                                <td colspan="2" class="fs-10 border-0 p-1 text-end">{{ $charge->label }} @if($charge->tax_rate > 0)({{ number_format($charge->tax_rate, 0) }}%)@endif :</td>
                            ...
                            <tr>
                                <td class="border-0"></td>
                                <td colspan="2" class="fs-10 border-0 p-1 text-end">Montant payé :</td>
                                <td colspan="2" class="fs-10 border-0 p-1 text-end">{{ number_format($invoice->amount_paid, 2, ',', ' ') }} {{ $currency }}</td>
                            </tr>
                            @endif
                            <tr>
                                <td class="border-0"></td>
                                <td colspan="2" class="fs-10 border-0 p-1 text-end">Reste à payer :</td>
                                <td colspan="2" class="fs-10 border-0 p-1 text-end">{{ number_format($invoice->amount_due, 2, ',', ' ') }} {{ $currency }}</td>
                            </tr>
                            <tr>
                                <td class="border-0"></td>
                                <td colspan="2" class="fs-10 border-dashed p-1 text-dark text-end fw-semibold">Total à payer :</td>
