...
<div class="content p-4">
        ...
        <div>
            @if($tenant)
                ...
                @if($logoPath && file_exists($logoPath))
                    <div class="mb-1 text-end"><img src="{{ $logoPath }}" alt="Logo" style="max-height: 50px;"></div>
                @endif
            @endif
    ...
    <div class="row mb-3">
        ...
        <div class="col-6 md-12 d-flex align-items-center justify-content-between">
            <p class="mb-1">Montant restant dû :</p>
            <span class="mb-1 fs-13 fw-noraml text-dark">{{ number_format($invoice->amount_due, 2, ',', ' ') }} {{ $currency }}</span>
        </div>
        <div class="col-6 md-12 d-flex align-items-center justify-content-between">
            <p class="mb-1">Date de facturation :</p>
            <span class="mb-1 fs-13 fw-noraml text-dark">{{ $invoice->issue_date?->format('d/m/Y') }}</span>
        </div>
        <div class="col-6 md-12 d-flex align-items-center justify-content-between">
            <p class="mb-1">Date d'échéance :</p>
            <span class="mb-1 fs-13 fw-noraml text-dark">{{ $invoice->due_date?->format('d/m/Y') }}</span>
        </div>
        <div class="col-6 md-12 d-flex align-items-center justify-content-between">
            <p class="mb-1">Total charges :</p>
            <span class="mb-1 fs-13 fw-noraml text-dark">{{ number_format($invoice->total, 2, ',', ' ') }} {{ $currency }}</span>
        </div>
        <div class="col-6 md-12 d-flex align-items-center justify-content-between">
            <p class="mb-1">Référence :</p>
            <span class="mb-1 fs-13 fw-noraml text-dark">{{ $invoice->reference_number ?? '-' }}</span>
        </div>
    </div>
