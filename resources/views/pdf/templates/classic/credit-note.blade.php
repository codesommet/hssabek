...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-applied { border-color: #0f5132; color: #0f5132; }
        .badge-partially_applied { border-color: #664d03; color: #664d03; }
...
<div class="page">
    ...
    <div class="doc-title-wrapper">
        <span class="doc-title">Avoir</span>
    </div>
        ...
        <tr>
            ...
            <td style="width: 45%;">
                <table class="doc-meta-table">
                    <tr><td>N°</td><td>{{ $creditNote->number }}</td></tr>
                    <tr><td>Date :</td><td>{{ $creditNote->issue_date?->format('d/m/Y') }}</td></tr>
                    @if($creditNote->reference_number)
                        <tr><td>Réf :</td><td>{{ $creditNote->reference_number }}</td></tr>
                    @endif
                    @if($creditNote->invoice)
                        <tr><td>Facture :</td><td>{{ $creditNote->invoice->number }}</td></tr>
                    @endif
                    <tr><td>Statut :</td><td><span class="badge badge-{{ $creditNote->status }}">{{ str_replace('_', ' ', ucfirst($creditNote->status)) }}</span></td></tr>
                </table>
            </td>
        </tr>
    </table>
