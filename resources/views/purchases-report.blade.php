			...
			<div class="content content-two">
				...
				<div class="mb-3">
                    ...
                    <div class="align-items-center gap-2 flex-wrap filter-info mt-3">
                        ...
                        <span class="tag bg-light border rounded-1 fs-12 text-dark badge"><span class="num-count d-inline-flex align-items-center justify-content-center bg-success fs-10 me-1">2</span>$10,000 - $25,500<span class="ms-1 tag-close"><i class="fa-solid fa-x fs-10"></i></span></span>                                           
