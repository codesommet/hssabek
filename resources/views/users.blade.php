                ...
                <table class="table table-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-dark">Customer</td>
                            <td class="text-dark">10 mins ago</td>
                            <td>07 Feb 2025</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="text-dark">Shop Owner</td>
                        ...
                        <tr>
                            ...
                            <td class="text-dark">Receptionist</td>
                            <td class="text-dark">Online</td>
                            <td>17 Jan 2025</td>
                            <td>
                                <span class="badge badge-soft-danger d-inline-flex align-items-center">Inactive
                        ...
                        <tr>
                            ...
                            <td class="text-dark">Customer</td>
                            <td class="text-dark">45 mins ago</td>
                            <td>09 Dec 2024</td>
                            <td>
                                <span class="badge badge-soft-danger d-inline-flex align-items-center">Inactive
                                    <i class="isax isax-close-circle ms-1"></i>
                        ...
                        <tr>
                            ...
                            <td class="text-dark">Shop Owner</td>
                            <td class="text-dark">2 hours ago</td>
                            <td>02 Dec 2024</td>
                            <td>
                                <span class="badge badge-soft-success d-inline-flex align-items-center">Active
                                    <i class="isax isax-tick-circle ms-1"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{URL::asset('build/img/users/user-32.jpg')}}" class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                            ...
                            <td class="text-dark">Admin</td>
                            <td class="text-dark">58 mins ago</td>
                            <td>30 Nov 2024</td>
                            <td>
                                <span class="badge badge-soft-success d-inline-flex align-items-center">Active
                                    <i class="isax isax-tick-circle ms-1"></i>
                        ...
                        <tr>
                            ...
                            <td class="text-dark">Receptionist</td>
                            <td class="text-dark">8 hours ago</td>
                            <td>09 Sep 2024</td>
                            <td>
                                <span class="badge badge-soft-danger d-inline-flex align-items-center">Inactive
                                    <i class="isax isax-close-circle ms-1"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 fw-medium mb-0"><a href="javascript:void(0);">Isabella Claire</a></h6>
                                    </div>
                                </div>
                            </td>
                            <td>+1 919-321-9876</td>
                            <td class="text-dark">Customer</td>
                            <td class="text-dark">1 day ago</td>
                            <td>07 Aug 2024</td>
                            <td>
                                <span class="badge badge-soft-danger d-inline-flex align-items-center">Inactive
                                    <i class="isax isax-close-circle ms-1"></i>
                            ...
                            <ul class="mb-3">
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img src="{{URL::asset('build/img/users/user-16.jpg')}}" class="flex-shrink-0 rounded-circle" alt="img"></span>Sarah Michelle
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img src="{{URL::asset('build/img/users/user-26.jpg')}}" class="flex-shrink-0 rounded-circle" alt="img"></span>Daniel Patrick
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img src="{{URL::asset('build/img/users/user-27.jpg')}}" class="flex-shrink-0 rounded-circle" alt="img"></span>Emily Lauren
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img src="{{URL::asset('build/img/users/user-28.jpg')}}" class="flex-shrink-0 rounded-circle" alt="img"></span>Braun Kelton
                                    </label>
                                </li>
                            </ul>
                            <div class="row g-2">
