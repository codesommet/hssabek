...
@section('content')
	...
	<div class="content invoice-dark p-4">

		<!-- start row -->
		<div class="row">
			<div class="col-md-10 mx-auto">
				<div class="mb-3">
					<h6><a href="{{url('invoice-templates')}}" class="text-white"><i class="isax isax-arrow-left me-1"></i>Back</a></h6>
				</div>
				<div>
					<div class="d-flex align-items-center justify-content-between bg-gray-9 p-3 rounded flex-wrap row-gap-3 mb-3">
						<div>
							<div class="mb-1"><img src="{{URL::asset('build/img/invoice-logo-white.svg')}}" alt=""></div>
						</div>
						<div>
					...
					<div class="d-flex align-items-center justify-content-between flex-wrap border-bottom mb-3">
						...
						<div class="text-center mb-3">
							...
							<span><img src="{{URL::asset('build/img/icons/sign-white.png')}}" alt=""></span>
						</div>
					</div>
