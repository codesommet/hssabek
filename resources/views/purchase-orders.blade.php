            ...
            <div class="content content-two">
                ...
                <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                        ...
                        <div>
                            <a href="{{url('add-purchases-orders')}}" class="btn btn-primary d-flex align-items-center"><i class="isax isax-add-circle5 me-1"></i>New Purchase Order</a>
                        </div>
                    </div>
                </div>
                <!-- /Breadcrumb -->
                            ...
                            <tr>
                                ...
                                <td class="action-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="{{url('edit-purchases-orders')}}" class="dropdown-item d-flex align-items-center"><i class="isax isax-edit me-2"></i>Edit</a>
                                        </li>
                                        <li>
