        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-11 mx-auto">
                    ...
                    <form action="{{ route('bo.purchases.vendor-bills.store') }}" method="POST" id="vendorBillForm">
                        @csrf
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div style="width:160px;">
                                                            <input type="number"
                                                                ...
                                                                value="{{ old('subtotal', $selectedPO?->subtotal ?? 0) }}"
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div style="width:160px;">
                                                            <input type="number"
                                                                ...
                                                                value="{{ old('tax_total', $selectedPO?->tax_total ?? 0) }}"
                                                                min="0" step="0.01">
                                                            @error('tax_total')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div style="width:160px;">
                                                            <input type="number"
                                                                ...
                                                                value="{{ old('total', $selectedPO?->total ?? 0) }}"
                                                                min="0" step="0.01" required>
                                                            @error('total')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
