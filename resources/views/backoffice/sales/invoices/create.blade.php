                    ...
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('bo.sales.invoices.store') }}" method="POST">
                                    @csrf
                                                    ...
                                                    <tr class="item-row">
                                                        ...
                                                        <td>
                                                            <input type="number" name="items[0][quantity]"
                                                                ...
                                                                step="0.001" style="min-width: 80px;" required>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="col-lg-5">
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <h6 class="fs-14 fw-semibold" id="display-subtotal">0,00</h6>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <h6 class="fs-14 fw-semibold">Remise</h6>
                                                        <h6 class="fs-14 fw-semibold text-danger" id="display-discount">
                                                            0,00</h6>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <h6 class="fs-14 fw-semibold">Taxe</h6>
                                                        <h6 class="fs-14 fw-semibold" id="display-tax">0,00</h6>
                                                    </div>
                                                    <div
