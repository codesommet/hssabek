                ...
                <div class="col-md-10 mx-auto">
                    <div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6><a href="{{ route('bo.finance.money-transfers.index') }}"><i class="isax isax-arrow-left me-2"></i>Transferts entre comptes</a></h6>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">Nouveau transfert</h5>
                                ...
                                <form action="{{ route('bo.finance.money-transfers.store') }}" method="POST">
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Compte source <span class="text-danger ms-1">*</span></label>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Compte destination <span class="text-danger ms-1">*</span></label>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('reference_number') is-invalid @enderror" name="reference_number" value="{{ old('reference_number') }}" placeholder="Ex: TR-001">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pt-4 border-top">
                                        <a href="{{ route('bo.finance.money-transfers.index') }}" class="btn btn-outline-white">Annuler</a>
