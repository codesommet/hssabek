            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">Nouveau compte bancaire</h5>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('account_type') is-invalid @enderror" name="account_type">
                                                    ...
                                                    <option value="current" {{ old('account_type') === 'current' ? 'selected' : '' }}>Courant</option>
                                                    <option value="savings" {{ old('account_type') === 'savings' ? 'selected' : '' }}>Épargne</option>
                                                    <option value="business" {{ old('account_type') === 'business' ? 'selected' : '' }}>Professionnel</option>
                                                    <option value="other" {{ old('account_type') === 'other' ? 'selected' : '' }}>Autre</option>
                                                </select>
