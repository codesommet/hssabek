<?php $page = 'customer-add-quotation'; ?>
                ...
                <div class="col-md-11 mx-auto">
                    <div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6><a href="{{url('customer-quotations')}}"><i class="isax isax-arrow-left me-2"></i>Quotations</a></h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{url('customer-quotations')}}">
                                    ...
                                    <div class="border-bottom mb-4 pb-3">
                                        ...
                                        <div class="table-responsive rounded table-nowrap border-bottom-0 border mb-4">
